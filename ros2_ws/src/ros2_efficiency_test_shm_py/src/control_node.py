...
class ControlNode(Node):
    def __init__(self):
        ...
        self.path_sub_ = self.create_subscription(Path, 'path', self.path_callback, 10)
        self.odom_sub_ = self.create_subscription(Odometry, 'odometry/rate_200hz', self.odom_callback, 10)

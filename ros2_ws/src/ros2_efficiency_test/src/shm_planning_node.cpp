...
public:
  PlanningNode() : Node("planning_node") {
    ...
    sync_ = std::make_shared<message_filters::TimeSynchronizer<
        nav_msgs::msg::Odometry, ros2_efficiency_test::msg::Image1m>>(odom_sub_,
                                                           disparity_sub_, 10);
...
private:
  void planning_callback(
      ...
      const ros2_efficiency_test::msg::Image1m::ConstSharedPtr &disparity_msg) {
    (void)disparity_msg;
  ...
  message_filters::Subscriber<ros2_efficiency_test::msg::Image1m> disparity_sub_;
  std::shared_ptr<message_filters::TimeSynchronizer<nav_msgs::msg::Odometry,
                                                    ros2_efficiency_test::msg::Image1m>>
      sync_;
